<template>
    <div class="">
        <div class="container ">
            <div class="hidden lg:flex justify-between items-center overflow-hidden border-b-[0.03px] border-green">
                <RouterLink to="/">
                ...
                <ul class="flex items-center gap-x-7">
                    ...
                    <li>
                        <button class="relative">
                            ...
                            <span
                                class="absolute h-5 w-5 bg-green rounded-full top-0 ring-0 border-2 border-[#fff] text-xs text-white">6</span>
                        </button>
                    </li>
                    <li>
                        <button
            ...
            <div class="lg:hidden mt-4 py-6 relative z-10 ">
                <div class="flex justify-between items-center">
                    ...
                    <button
                        class="h-11 w-11 rounded-2xl bg-green flex items-center justify-center shrink-0   shadow-[3px_5px_10px_0px_rgba(70,_163,_88,_0.50)]"><img
                            src="../../img/btn.svg" alt="" @click="toggleBtn = !toggleBtn"></button>
                </div>
                <div class="bg-zinc-400 fixed top-0 h-full max-w-[250px] w-full px-6 pt-10 duration-300 flex items-start justify-between" :class="toggleBtn ? 'left-0' : '-left-full'">
                    <div>
                        <ul>
                            <li v-for="item, index in links" :key="index">
                                <RouterLink :to="item.link" class="text-xl text-white pb-3 block hover:text-green">{{ item.text }}</RouterLink>
                            </li>
                        </ul>
